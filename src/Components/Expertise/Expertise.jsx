...
const Expertise = () => {
  ...
  <h1 className="heading pb-2">Why me ! </h1>
     ...
     data-aos-duration="600" >
           <div className="w-1/3 mx-auto "> <img className="transition duration-200 transform hover:-translate-y-2" src="https://i.ibb.co/4JKQCJn/Unique-Idea.png  " alt="" /></div>
     ...
     data-aos-anchor-placement="center-bottom"
     data-aos-duration="600">
         <div className="w-1/3 mx-auto"> <img className="transition duration-200 transform hover:-translate-y-2" src="https://i.ibb.co/WyQJrnr/Pixel-Perfect.png " alt="" />  </div>
...
pixel aligns harmoniously to achieve visual perfection.</p>
     ...
     data-aos-anchor-placement="center-bottom"
     data-aos-duration="600">
         <div className="w-1/3 mx-auto"> <img className="transition duration-200 transform hover:-translate-y-2" src="https://i.ibb.co/nfJTpRH/On-Time.png  " alt="" />  </div>
