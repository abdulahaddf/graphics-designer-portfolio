...
const Projects = () => {
  ...
  {projects.slice(0, 4).map((pro) => (
    ...
    >
      ...
      <div
        className="bg-black px-6 py-4 bg-opacity-50 opacity-0 hover:opacity-100 text-white absolute inset-0 transition-opacity duration-200 flex flex-col items-center justify-center text-center"
      >
        <Link
          to={pro.description}
          target="_blank"
        ...
        >
          Learn More <MdOutlineSubdirectoryArrowRight className="w-10 mx-auto" />
        </Link>
      </div>
    </div>
  ))}
...
<div className=" text-center mt-10">
    <Link to="/allProjects" className="btn-new" offset={-150}>See More</Link>
</div>
